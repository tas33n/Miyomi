...
INSERT INTO guides (title, slug, category, author, status, tags, content, updated_at, metadata) VALUES (
  ...
  '<!-- Container Card -->
<div class="not-prose" style="background-color: #0B1120; border-radius: 12px; padding: 32px; border: 1px solid #1e293b; color: #cbd5e1; font-family: Inter, sans-serif;">
  ...
  <!-- Prerequisites -->
  <h2 style="color: #ffffff; font-size: 24px; font-weight: 700; margin-bottom: 16px; margin-top: 0;">Prerequisites</h2>
  <ul style="list-style: none; padding: 0; margin-bottom: 32px;">
    <li style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
        <span style="display: inline-block; width: 8px; height: 8px; border-radius: 50%; background-color: #3b82f6; margin-top: 8px; flex-shrink: 0;"></span>
  ...
  <!-- Step 1 -->
  <h2 style="color: #ffffff; font-size: 20px; font-weight: 700; margin-bottom: 16px;">Step 1: Enable Unknown Sources</h2>
  <p style="margin-bottom: 16px;">Before installing Mihon, you need to allow installation from unknown sources:</p>
  <ul style="list-style: none; padding: 0; margin-bottom: 32px;">
    <li style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
        <span style="display: inline-block; width: 6px; height: 6px; border-radius: 50%; background-color: #3b82f6; margin-top: 9px; flex-shrink: 0; opacity: 0.8;"></span>
  ...
  <div style="background-color: rgba(59, 130, 246, 0.1); border-left: 4px solid #3b82f6; padding: 16px; border-radius: 4px; font-style: italic; margin-bottom: 32px;">
    Note: The exact steps may vary depending on your Android version and device manufacturer.
  </div>

  <!-- Step 2 -->
  <h2 style="color: #ffffff; font-size: 20px; font-weight: 700; margin-bottom: 16px;">Step 2: Download Mihon</h2>
  <ul style="list-style: none; padding: 0; margin-bottom: 32px;">
    <li style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
        <span style="display: inline-block; width: 6px; height: 6px; border-radius: 50%; background-color: #3b82f6; margin-top: 9px; flex-shrink: 0; opacity: 0.8;"></span>
        <span>Visit the official <a href="#" style="color: #60a5fa; text-decoration: none;">GitHub releases page</a></span>
    </li>
    <li style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
        <span style="display: inline-block; width: 6px; height: 6px; border-radius: 50%; background-color: #3b82f6; margin-top: 9px; flex-shrink: 0; opacity: 0.8;"></span>
  ...
  <!-- Step 3 -->
  <h2 style="color: #ffffff; font-size: 20px; font-weight: 700; margin-bottom: 16px;">Step 3: Install the App</h2>
  <ul style="list-style: none; padding: 0; margin-bottom: 32px;">
    <li style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
        <span style="display: inline-block; width: 6px; height: 6px; border-radius: 50%; background-color: #3b82f6; margin-top: 9px; flex-shrink: 0; opacity: 0.8;"></span>
...
) ON CONFLICT (slug) DO UPDATE SET content = EXCLUDED.content, status = EXCLUDED.status, scene = EXCLUDED.scene;
